...
APPEND WSMITH01
  ...
  IF ~~ THEN BEGIN XO#ItemUp2 SAY @1234983
  ...
  IF ~~ THEN BEGIN XO#ItemUp3 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp4 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp5 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp6 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp7 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp8 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp9 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp10 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp11 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp12 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)
  ...
  IF ~~ THEN BEGIN XO#ItemUp13 SAY @1234983
    IF ~PartyGoldLT(10000)~ THEN REPLY #66662 GOTO XO#NoItemUp
    IF ~PartyGoldGT(9999)~ THEN REPLY #66664 DO ~SetGlobal("XO#ItemUp","ar0334",42)
    SetGlobal("ForgeStuff","GLOBAL",1)
    TakePartyGold(10000)

  ...
  IF ~~ THEN BEGIN c2itemupgrade // from: 151.1 151.0 2.1 2.0
    ...
    IF ~OR(3) PartyHasItem("ring07") PartyHasItem("cdpp12") PartyHasItem("c!pp12")~ THEN REPLY @56783 GOTO rop2
    ...
    IF ~OR(3) PartyHasItem("amul14") PartyHasItem("cdpp7") PartyHasItem("c!pp7")~ THEN REPLY @567837 GOTO ilmater
    IF ~PartyHasItem("sw1h52")~ THEN REPLY @567838 GOTO water
    IF ~PartyHasItem("ax1h10")~ THEN REPLY @567839 GOTO azur
    IF ~OR(2) PartyHasItem("ring08") PartyHasItem("ring08a")~ THEN REPLY @567891 GOTO sorcerian
    IF ~PartyHasItem("belt03")~ THEN REPLY @567892 GOTO girdle
  ...
  IF ~~ THEN BEGIN robe
    SAY @567855 = @56789955 IF ~~ THEN REPLY @567835 GOTO c2itemupgrade
    IF ~PartyHasItem("clck15") PartyHasItem("clck01") !PartyHasItem("cdpp8") !PartyHasItem("c!pp8") 
      ...
      DO ~TakePartyGold(20000)      DestroyGold(20000)
          ...
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("clck15") PartyHasItem("cdpp8") !PartyHasItem("c!pp8")
        PartyHasItem("scrl7u") PartyHasItem("scrl5k")
        PartyGoldGT(19999)~
      THEN REPLY @123456 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
          ...
          GiveItemCreate("c2robe01",Player1,1,1,1)
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("clck15") PartyHasItem("c!pp8")
        PartyHasItem("scrl7u") PartyHasItem("scrl5k")
        PartyGoldGT(19999)~
      THEN REPLY @123456 
      DO ~TakePartyGold(20000)      DestroyGold(20000)
  ...
  IF ~~ THEN BEGIN ilmater
    SAY @567887 = @5678987 IF ~~ THEN REPLY @567835 GOTO c2itemupgrade
    ...
    IF ~PartyHasItem("amul22") PartyHasItem("amul24") 
        ...
        NumItemsPartyLT("cdpp7",2)
        NumItemsPartyLT("c!pp7",2)
        PartyGoldGT(9999)~
      THEN REPLY @567836 
      DO ~TakePartyGold(10000)      DestroyGold(10000)
          TakePartyItemNum("amul22",1)   DestroyItem("amul22")
          TakePartyItemNum("amul24",1)   DestroyItem("amul24")
          TakePartyItemNum("amul25",1)   DestroyItem("amul25")
          TakePartyItemNum("amul14",2)   DestroyItem("amul14") DestroyItem("amul14")
          GiveItemCreate("c2amul01",Player1,1,1,1)
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("amul22") PartyHasItem("amul24") 
        PartyHasItem("amul25")
      ...
      DO ~TakePartyGold(10000)      DestroyGold(10000)
          ...
          TakePartyItemNum("amul24",1)   DestroyItem("amul24")
          TakePartyItemNum("amul25",1)   DestroyItem("amul25")
          TakePartyItemNum("cdpp7",2)   DestroyItem("cdpp7")  DestroyItem("cdpp7")
          GiveItemCreate("c2amul01",Player1,1,1,1)
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
    IF ~PartyHasItem("amul22") PartyHasItem("amul24") 
        PartyHasItem("amul25")
      ...
      DO ~TakePartyGold(10000)      DestroyGold(10000)
          ...
          TakePartyItemNum("amul24",1)   DestroyItem("amul24")
          TakePartyItemNum("amul25",1)   DestroyItem("amul25")
          TakePartyItemNum("c!pp7",2)   DestroyItem("c!pp7")  DestroyItem("c!pp7")
          GiveItemCreate("c2amul01",Player1,1,1,1)
          CreateVisualEffect("spcrtwpn",[401.348])~ EXIT
  END
  ...
  IF ~~ THEN BEGIN girdle
    SAY @567893 = @56789993 IF ~~ THEN REPLY @567835 GOTO c2itemupgrade
